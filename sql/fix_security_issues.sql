...
SELECT
    ...
    count(*) FILTER (WHERE complaint_type::text = 'store_service'::text) AS store_service_count,
    count(*) FILTER (WHERE complaint_type::text = 'packing_error'::text) AS packing_error_count,
    count(*) FILTER (WHERE complaint_type::text = 'price_discrepancy'::text) AS price_discrepancy_count,
    count(*) FILTER (WHERE complaint_type::text = 'phone_support'::text) AS phone_support_count,
    count(*) FILTER (WHERE complaint_type::text = 'date_error'::text) AS date_error_count,
    count(*) FILTER (WHERE complaint_type::text = 'address_error'::text) AS address_error_count,
    count(*) FILTER (WHERE complaint_type::text = 'quantity_error'::text) AS quantity_error_count,
    count(*) FILTER (WHERE complaint_type::text = 'delay'::text) AS delay_count,
    count(*) FILTER (WHERE complaint_type::text = 'contamination'::text) AS contamination_count,
    count(*) FILTER (WHERE complaint_type::text = 'taste'::text) AS taste_count,
